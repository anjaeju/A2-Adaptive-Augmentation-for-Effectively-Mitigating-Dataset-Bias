...
if __name__=='__main__':
    ...
    model.load_state_dict(torch.load(f'{args.save_root}/best.path.tar')['model_state_dict'])
    model.eval()
    ...
    K = 10
    target_path = './samples/extracted-bias-conflict/'
